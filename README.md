...
* **[Added support for groups in conv layers for LoRA](https://github.com/huggingface/peft/pull/2567)** - `peft`
    * **Description:** Issue [#2549]((https://github.com/huggingface/peft/pull/2567)) is about error in initializing the model with peft approach of dora and lora and errors in the forward pass for conv layers with `groups>1`. This fix is an approach to resolve the errors by including `groups` as part of the definition of `lora_B` parameter.
    * **Status:** Review
